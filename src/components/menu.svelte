...
<!-- {#if $MenuStore.show} -->
  <section style="display: {$MenuStore.show ? 'flex' : 'none'};" class="w-[60vw] h-[50vh] flex-col bg-[#171717] rounded-t-2xl shadow-lg text-white" use:draggable={{ handle: menuHandle, bounds: 'body', gpuAcceleration: false }}>
