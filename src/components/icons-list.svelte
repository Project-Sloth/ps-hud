<script lang="ts">
  ...
  let width: number = 55;
  let stroke: number = 14;
  let shape: shapeType['shape'] = "square-circular-fill"
  let rotate: number = 0;
  let translateX: number = 0;
  let translateY: number = 0;
  let iconScaling: number = 0.55;
  let iconColor: string = "";
  let iconTranslateX: number = 0;
  let iconTranslateY: number = 0;
  let innerColor: string = "transparent";
  let outlineColor: string = "";
  let outlineColorOpacity: number = 0.2;
