...
Config.Fuel = {
    enable = true, -- If you use ox_fuel so  set this to false 
    script = 'LegacyFuel', -- change to lj-fuel if you use lj-fuel or something else if you use any other LegcyFuel compatible script
}
