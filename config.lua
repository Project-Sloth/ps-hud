...
Config.UseMPH = true -- If true speed math will be done as MPH, if false KMH will be used (YOU HAVE TO CHANGE CONTENT IN STYLES.CSS TO DISPLAY THE CORRECT TEXT)
