...
JSTranslations = {
    ...
    status_icons = {
        ...
        shapes = {
            "Badge", "Circle Ring", "Circle Ring Whole", "Circle Circle Fill", "Circle Square Fill", "Circle Whole", "Diamond Ring", "Diamond Whole",
            "Flower", "Hexagon Ring", "Hexagon Whole", "Horizontal Bar", "Icon Percentage", "Pill Ring", "Pill Whole", "Square Circular Fill",
            "Square Ring", "Square Whole", "Star Ring", "Triangle Ring"
        },
        ...
        status_icon_names = {
            "Voice", "Health", "Armor", "Hunger", "Thirst", "Stress", "Oxygen", "Armed", "Parachute", "Engine", "Harness",
            "Cruise", "Nitro", "Dev", "Playerid"
        },
    ...
    layouts = {
        ...
        layout_names = {
            "Standard", "Bottom Right Row", "Center Bottom Row", "Left Bottom Column", "Right Bottom Column",
            "Top Left Row", "Top Right Row"
        },
    ...
    custom_profiles = {
        ...
        apply_profile_to_hud = "Apply Profile To Hud!",
