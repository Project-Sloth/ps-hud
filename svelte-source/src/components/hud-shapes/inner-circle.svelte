<script lang="ts">
  ...
  export let borderGap: number = 0.85;
  ...
  $: strokeDashoffset = progressbarCircumference - $progressTween / 100 * progressbarCircumference;
</script>
  ...
  >
    ...
    {#if displayOutline}
      <circle
        ...
        stroke={outlineColor}
        stroke-dashoffset={0}
        stroke-dasharray={progressbarCircumference + ' ' + progressbarCircumference}
